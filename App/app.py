...
with cols[0]:
    if os.path.exists("Output\original.jpg"):
        st.image("Output\original.jpg", caption="📷 Original", use_container_width=True)
...
with cols[2]:
    if os.path.exists("Output\monet_gen.png"):
        st.image("Output\monet_gen.png", caption="🎨 Monet Style", use_container_width=True)
...
with cols[4]:
    if os.path.exists("Output\photo_gen.png"):
        st.image("Output\photo_gen.png", caption="📸 Reconstructed Photo", use_container_width=True)
