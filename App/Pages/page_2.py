...
def load_generator_model():
    ...
    model = tf.keras.models.load_model("Model\Trained\photo_generator_model.h5", compile=False, custom_objects=custom_objects)
    return model
...
if uploaded_file:
    ...
    os.makedirs("Output\Generated\photo", exist_ok=True)
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    save_path = f"Output\Generated\photo\photo_{timestamp}.png"
